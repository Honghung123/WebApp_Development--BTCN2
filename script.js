...
console.log(data);
data = await DBProvider.fetch(`detail/movie/tt0012349`);
console.log(data);
data = await DBProvider.fetch(`search/name/smith?per_page=10&page=2`);
console.log(data);
...
console.log(data);
data = await DBProvider.fetch(`get/mostpopular/?per_page=30&page=2`);
console.log(data);
